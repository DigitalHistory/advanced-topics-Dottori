...
var my_center = new google.maps.LatLng(47.623026, -122.33984); // center of map
...
var legendHTML =
  "<h2>Legend:</h2><h3>The Impact of Gentrification on monthly 1BR Rental Rates in Seattle</h3";
      ...
      geometry: {
        ...
        coordinates: [
          [
            ...
            [-96.6796875, 40.713955826286046],
            [-79.62890625, 37.71859032558816],
            [-81.2109375, 49.26780455063753],
            [-85.60546875, 49.03786794532644]
          ]
        ]
      }
      ...
      geometry: {
        ...
        coordinates: [
          [
            ...
            [-114.78515624999999, 51.944264879028765],
            [-101.6015625, 51.944264879028765],
            [-112.32421875, 58.263287052486035],
            [-113.203125, 58.35563036280967]
          ]
        ]
      }
...
function initializeMap() {
  ...
  var all_my_markers = [
    {
      ...
      window_content:
        "<h3>Amazon HQ</h3><p>Amazon's headquarter is located within the South Lake Union corridor.</p>"
    },
    {
      ...
      window_content:
        "<h3>South Lake Union ($1,900)</h3><p>This formererly dilapidated warehouse and industrial region now houses the Amazon HQ.</p>"
    },
    {
      ...
      window_content:
        "<h3>Belltown ($1,910) </h3><p>Located on Settle's waterfront, this former low-rent industrial artdistrict has been transformed into a trendy restaurant and boutique-filled neighbourhood that houses a portion of the Amazon complex. and it has also experienced drastically increasing rental rates.</p>"
    },
    {
      position: new google.maps.LatLng(47.62414, -122.35631),
      map: my_map,
      icon: blueURL, // this sets the image that represents the marker in the map
      title: "Lower Queen Anne ($1,675)",
      window_content:
        "<h3>Lower Queen Anne ($1,675)</h3><p>A neighbourhing corridor, LQA has also seen marked but less drastic increases in rental costs.</p>"
    },
    {
      ...
      window_content:
        "<h3>East Queen Anne ($1,630)</h3><p>A more economical neighbourhood of mostly single mid-twenties, early-thirties professionals.</p>"
    },
    {
      ...
      window_content:
        "<h3>Pike Place Market ($1,725)</h3><p>A popular tourist spot. This public market opened in 1907 and is one of Seattle's main attractions.</p>"
    },
    {
      ...
      window_content:
        "<h3>Broadway ($1,600)</h3><p>A major thoroughfare, this district houses major transit streets. All the better to get to work!</p>"
    }
  ];
  ...
  for (j = 0; j < all_my_markers.length; j++) {
    ...
    legendHTML +=
      '<div class="pointer" onclick="locateMarker(my_markers[' +
      j +
      '])"> ' +
      marker.window_content +
      "</div>";
    marker.info = new google.maps.InfoWindow({
      content: marker.window_content
    });
